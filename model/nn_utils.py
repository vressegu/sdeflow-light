...
from torch          import arange, cat, cos, enable_grad, exp, no_grad, sigmoid, sin, zeros_like
from torch          import float32 as t_float32
from torch.autograd import Function, grad
from torch.nn       import AvgPool1d, AvgPool2d, AvgPool3d, Conv1d, Conv2d, Conv3d, GroupNorm, Linear, Module
...
def timestep_embedding(timesteps, dim, max_period=10000):
	...
	half = dim // 2
	freqs = exp(
		-log(max_period) * arange(start=0, end=half, dtype=t_float32) / half
